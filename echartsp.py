...
class ECharts(PaneBase):
    ...
    theme = param.ObjectSelector(default="default", objects=["default", "light", "dark","azul", "bee-inspired", "blue", "caravan", "carp", "cool", "dark-blue", "dark-bold", "dark-digerati", "dark-fresh-cut", "dark-mushroom", "eduardo", "forest", "fresh-cut", "fruit", "gray", "green", "helianthus", "infographic", "inspired", "jazz", "london", "macarons", "macarons2", "mint", "red", "red-velvet", "roma", "royal", "sakura", "shine", "tech-blue", "vintage"], doc="""
