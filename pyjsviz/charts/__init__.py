...
Area(data=None, kdims=None, vdims=None, **kwargs)

Bars(data=None, kdims=None, vdims=None, **kwargs)

Bivariate(data=None, kdims=None, vdims=None, **kwargs)

BoxWhisker(data=None, kdims=None, vdims=None, **kwargs)

Chord(data=None, kdims=None, vdims=None, **kwargs)

Contours(data=None, kdims=None, vdims=None, **kwargs)

Curve(data=None, kdims=None, vdims=None, **kwargs)

Distribution(data=None, kdims=None, vdims=None, **kwargs)

ErrorBars(data=None, kdims=None, vdims=None, **kwargs)

HeatMap(data=None, kdims=None, vdims=None, **kwargs)

HexTiles(data=None, kdims=None, vdims=None, **kwargs)

Histogram(data=None, kdims=None, vdims=None, **kwargs)

Sankey(data=None, kdims=None, vdims=None, **kwargs)

Scatter(data=None, kdims=None, vdims=None, **kwargs)

Scatter3D(data=None, kdims=None, vdims=None, **kwargs)

Spikes(data=None, kdims=None, vdims=None, **kwargs)

Surface(data=None, kdims=None, vdims=None, **kwargs)

Violin(data=None, kdims=None, vdims=None, **kwargs)
