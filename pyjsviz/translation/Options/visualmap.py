...
class VisualMapContinuous(BaseModel):
	...
	indicatorIcon: Literal['circle', 'rect', 'roundRect', 'triangle', 'diamond', 'pin', 'arrow']  = 'circle'
...
class VisualMapPiecewise(BaseModel):
	...
	itemGap: int = 10
	itemSymbol: Literal['circle', 'rect', 'roundRect', 'triangle', 'diamond', 'pin', 'arrow', 'none'] = 'roundRect'
	show: bool = True
	dimension :Optional[str]
	seriesIndex: Optional[Union[int,List[int]]]
	hoverLink: bool = True
