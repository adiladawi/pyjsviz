...
class Data(BaseModel):
	...
	y: Optional[int]
	value: Optional[int]
	symbol: Optional[Literal['pin', 'emptyCircle', 'circle', 'rect', 'roundRect', 'triangle', 'diamond', 'arrow', 'none']]
...
class MarkPoint(BaseModel):
	symbol: Literal['pin', 'emptyCircle', 'circle', 'rect', 'roundRect', 'triangle', 'diamond', 'arrow', 'none'] = 'pin'
	symbolSize: int = 50
	symbolRotate: Optional[int]
	symbolKeepAspect: bool = False
	symbolOffset: Optional[List] = [0, 0]
