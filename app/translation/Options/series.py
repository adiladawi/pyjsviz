...
class LineData(BaseModel):
	name: Optional[str]
	value: Optional[int]
	symbol: Literal['emptyCircle', 'circle', 'rect', 'roundRect', 'triangle', 'diamond', 'pin', 'arrow', 'none'] = 'circle'
	symbolSize: int = 4
...
class ScatterData(BaseModel):
	name: Optional[str]
	value: Optional[int]
	symbol: Optional[Literal['emptyCircle', 'circle', 'rect', 'roundRect', 'triangle', 'diamond', 'pin', 'arrow', 'none']]
...
class GraphEdgeLabel(BaseModel):
	...
	fontFamily: Literal['sans-serif', 'serif','monospace','Arial','Courier New'] = 'sans-serif'
	fontSize: int = 12
...
class GraphCategories(BaseModel):
	name: Optional[str]
	symbol: Optional[Literal['circle', 'rect', 'roundRect', 'triangle', 'diamond', 'pin', 'arrow', 'none']]
	symbolSize: Optional[int]
	symbolRotate: Optional[int]
	symbolKeepAspect: bool = False
	symbolOffset: List[int] = [0, 0]
...
class PictorialBarData(BaseModel):
	name: Optional[str]
	value: Optional[int]
	symbol: Literal['circle', 'rect', 'roundRect', 'triangle', 'diamond', 'pin', 'arrow', 'none'] = 'circle'
...
class Line(BaseModel):
	...
	animationThreshold: int = 2000
	animationDuration: int = 1000
	animationEasing: Literal['quinticInOut','linear','quadraticIn','quadraticInOut','cubicIn','cubicOut','cubicInOut','quarticIn','quarticOut', 'quarticInOut', 'quinticIn', 'quinticOut', 'sinusoidalIn', 'sinusoidalOut', 'sinusoidalInOut' , 'exponentialIn', 'exponentialOut', 'exponentialInOut', 'circularIn', 'circularOut', 'circularInOut', 'elasticIn', 'elasticOut', 'elasticInOut','backIn','backOut', 'backInOut','bounceIn','bounceOut','bounceInOut'] = 'linear'
	animationDelay: int = 0
	animationDurationUpdate: int = 300
	animationEasingUpdate: Literal['quinticInOut','linear','quadraticIn','quadraticInOut','cubicIn','cubicOut','cubicInOut','quarticIn','quarticOut', 'quarticInOut', 'quinticIn', 'quinticOut', 'sinusoidalIn', 'sinusoidalOut', 'sinusoidalInOut' , 'exponentialIn', 'exponentialOut', 'exponentialInOut', 'circularIn', 'circularOut', 'circularInOut', 'elasticIn', 'elasticOut', 'elasticInOut','backIn','backOut', 'backInOut','bounceIn','bounceOut','bounceInOut'] = 'cubicOut'
	animationDelayUpdate: int = 0
...
class BoxPlot(BaseModel):
	...
	animationEasing: Literal['quinticInOut','linear','quadraticIn','quadraticInOut','cubicIn','cubicOut','cubicInOut','quarticIn','quarticOut','quarticInOut', 'quinticIn', 'quinticOut', 'sinusoidalIn', 'sinusoidalOut', 'sinusoidalInOut' , 'exponentialIn', 'exponentialOut', 'exponentialInOut', 'circularIn', 'circularOut', 'circularInOut', 'elasticIn', 'elasticOut', 'elasticInOut','backIn','backOut', 'backInOut','bounceIn','bounceOut','bounceInOut'] = 'elasticOut'
	animationDelay: int = 0
	tooltip: Any = ToolTip().dict()
...
class Lines(BaseModel):
	...
	large: bool = True
	largeThreshold: int = 2000
	symbol: Literal['emptyCircle','circle', 'rect', 'roundRect', 'triangle', 'diamond', 'pin', 'arrow', 'none'] = 'none'
	symbolSize: int = 10
	lineStyle: Any = LineStyle().dict()
	label: Any = Label().dict()
	labelLayout: Any = LabelLayout().dict()
